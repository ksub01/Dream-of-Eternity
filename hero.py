...
text_skills = ['', '1 Длань господа *{}*: вы наносите мощный удар, который в раз\n'
               'больше вашей атаки. Сила зависит от прокачки. Один раз за бой',
               '2 Божественное провиденье *{}*: Увеличивает вашу атаку на ',
               '3 Демонический облик *{}*: Ваша атака увеличивается в 2 раза,\n'
               'но вы возвращаете [50, 40, 30] процентов урона себе']
skills_lord = {'Длань Господа': {'grade': [0, 5, 10, 15], 'info': text_skills[2]},
               'Божественное провиденье': {'grade': [0, 5, 10, 20], 'info': text_skills[2]},
               'Демоническая ярость': {'grade': [0, 50, 40, 30], 'info': text_skills[3]}}
