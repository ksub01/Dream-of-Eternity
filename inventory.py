...
def put_on_thing():
    """сложно. Функция снимает с игрока вещь, если на нём она есть, которую он выбрал и надевает новую которую он выберет,
...
def choice_item():
    """сложно. Функция, которая находит вещь под выбранным номером и возвращает её словарь для обработки, ничего не принимает
    """
    great_num = 10000000000000000000000
    thing = {}
